function [ res ] = del_u_average_n_v_tensor_jump_minus_plus_local_21...
...
JIT_neighbour = [grid.JIT(tria_index_neighbour,:,1)',...
...
for k = 1:1:params.ndofs_per_element
    global_basis_derivative{k} = (JIT_neighbour * (basis_derivative{k})')';
end
