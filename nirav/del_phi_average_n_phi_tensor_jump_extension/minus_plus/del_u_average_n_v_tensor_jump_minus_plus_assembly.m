function [res] = del_u_average_n_v_tensor_jump_minus_plus_assembly...
    (grid,params)
...
res_minus_plus_11 = zeros(params.ndofs);
res_minus_plus_12 = zeros(params.ndofs);
res_minus_plus_21 = zeros(params.ndofs);
res_minus_plus_22 = zeros(params.ndofs);
...
for i=1:1:length(tria_index)
    ...
    if tria_index_neighbour > 0
        res_minus_plus_11(gids_velocity(tria_index(i),:),...
            ...
            = res_minus_plus_11(gids_velocity(tria_index(i),:),...
            gids_velocity(tria_index_neighbour,:)) + ...
            del_u_average_n_v_tensor_jump_minus_plus_integral_11...
...
for i=1:1:length(tria_index)
    ...
    if tria_index_neighbour > 0
        res_minus_plus_12(gids_velocity(tria_index(i),:),...
            ...
            = res_minus_plus_12(gids_velocity(tria_index(i),:),...
            gids_velocity(tria_index_neighbour,:)) + ...
            del_u_average_n_v_tensor_jump_minus_plus_integral_12...
            (params,grid,tria_index(i),local_vertex_index(i));
    end
end
...
for i=1:1:length(tria_index)
    ...
    if tria_index_neighbour > 0
        res_minus_plus_21(gids_velocity(tria_index(i),:),...
            ...
            = res_minus_plus_21(gids_velocity(tria_index(i),:),...
            gids_velocity(tria_index_neighbour,:)) + ...
            del_u_average_n_v_tensor_jump_minus_plus_integral_21...
            (params,grid,tria_index(i),local_vertex_index(i));
    end
end
...
for i=1:1:length(tria_index)
    ...
    if tria_index_neighbour > 0
        res_minus_plus_22(gids_velocity(tria_index(i),:),...
            ...
            = res_minus_plus_22(gids_velocity(tria_index(i),:),...
            gids_velocity(tria_index_neighbour,:)) + ...
            del_u_average_n_v_tensor_jump_minus_plus_integral_22...
            (params,grid,tria_index(i),local_vertex_index(i));
    end
end
