function [res] = n_u_tensor_jump_n_phi_tensor_jump_plus_plus_assembly...
    (grid,params)
...
for i=1:1:length(tria_index)
    res_plus_plus_11(gids_velocity(tria_index(i),:),...
        ...
        = res_plus_plus_11(gids_velocity(tria_index(i),:),...
        gids_velocity(tria_index(i),:)) + ...
        n_u_tensor_jump_n_phi_tensor_jump_plus_plus_integral_11...
...
for i=1:1:length(tria_index)
    res_plus_plus_12(gids_velocity(tria_index(i),:),...
        ...
        = res_plus_plus_12(gids_velocity(tria_index(i),:),...
        gids_velocity(tria_index(i),:)) + ...
        n_u_tensor_jump_n_phi_tensor_jump_plus_plus_integral_12...
        (params,grid,tria_index(i),local_vertex_index(i));
end
...
for i=1:1:length(tria_index)
    res_plus_plus_21(gids_velocity(tria_index(i),:),...
        ...
        = res_plus_plus_21(gids_velocity(tria_index(i),:),...
        gids_velocity(tria_index(i),:)) + ...
        n_u_tensor_jump_n_phi_tensor_jump_plus_plus_integral_21...
        (params,grid,tria_index(i),local_vertex_index(i));
end
...
for i=1:1:length(tria_index)
    res_plus_plus_22(gids_velocity(tria_index(i),:),...
        ...
        = res_plus_plus_22(gids_velocity(tria_index(i),:),...
        gids_velocity(tria_index(i),:)) + ...
        n_u_tensor_jump_n_phi_tensor_jump_plus_plus_integral_22...
        (params,grid,tria_index(i),local_vertex_index(i));
end
