...
res_minus_minus_11 = sparse(zeros(paramsP.ndofs_per_element * ...
    grid.nelements, params.ndofs_per_element * ...
    grid.nelements));
res_minus_minus_12 = sparse(zeros(paramsP.ndofs_per_element * ...
    grid.nelements, params.ndofs_per_element * ...
    grid.nelements));
res_minus_minus_21 = sparse(zeros(paramsP.ndofs_per_element * ...
    grid.nelements, params.ndofs_per_element * ...
    grid.nelements));
res_minus_minus_22 = sparse(zeros(paramsP.ndofs_per_element * ...
    grid.nelements, params.ndofs_per_element * ...
    grid.nelements));
...
for i=1:1:length(tria_index)
    ...
    if tria_index_neighbour > 0
        res_minus_minus_11(gids_pressure(tria_index_neighbour,:), ...
...
for i=1:1:length(tria_index)
    tria_index_neighbour = grid.NBI(tria_index(i),local_vertex_index(i));
    if tria_index_neighbour > 0
        res_minus_minus_12(gids_pressure(tria_index_neighbour,:), ...
            gids_velocity(tria_index_neighbour,:)) = ...
            res_minus_minus_12(gids_pressure(tria_index_neighbour,:), ...
            gids_velocity(tria_index_neighbour,:)) + ...
...
for i=1:1:length(tria_index)
    tria_index_neighbour = grid.NBI(tria_index(i),local_vertex_index(i));
    if tria_index_neighbour > 0
        res_minus_minus_21(gids_pressure(tria_index_neighbour,:), ...
            gids_velocity(tria_index_neighbour,:)) = ...
            res_minus_minus_21(gids_pressure(tria_index_neighbour,:), ...
            gids_velocity(tria_index_neighbour,:)) + ...
...
for i=1:1:length(tria_index)
    tria_index_neighbour = grid.NBI(tria_index(i),local_vertex_index(i));
    if tria_index_neighbour > 0
        res_minus_minus_22(gids_pressure(tria_index_neighbour,:), ...
            gids_velocity(tria_index_neighbour,:)) = ...
            res_minus_minus_22(gids_pressure(tria_index_neighbour,:), ...
            gids_velocity(tria_index_neighbour,:)) + ...
...
res.res = res_minus_minus_11 + res_minus_minus_12 + ...
