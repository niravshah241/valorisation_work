...
hold off
axis tight
legend('Maximum reduced basis velocity error','Average reduced basis velocity error');
xlabel('Size of reduced basis');
ylabel('Reduced basis velocity error (log scale)');
title('Size of reduced basis vs velocity error (semilog scale)');
saveas(a,'nirav/pod_galerkin/size_vs_reduced_basis_velocity_error_semilog.fig');
saveas(a,'nirav/pod_galerkin/size_vs_reduced_basis_velocity_error_semilog.jpg');
...
hold off
axis tight
legend('Maximum reduced basis pressure error','Average reduced basis pressure error');
xlabel('Size of reduced basis');
ylabel('Reduced basis pressure error (log scale)');
title('Size of reduced basis vs pressure error (semilog scale)');
saveas(a,'nirav/pod_galerkin/size_vs_reduced_basis_pressure_error_semilog.fig');
saveas(a,'nirav/pod_galerkin/size_vs_reduced_basis_pressure_error_semilog.jpg');
