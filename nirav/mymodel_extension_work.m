...
% 
% figure()
% plot(real(eigen_values_velocity),'*')
% axis tight
% xlabel('number of eigen value')
% ylabel('eigenvalues velocity')
% title('velocity eigenvalues')
% 
% figure()
% plot(real(eigen_values_pressure),'*')
% axis tight
% xlabel('number of eigen value')
% ylabel('eigenvalues pressure')
% title('pressure eigenvalues')
% 
% figure()
...
% 
% figure()
% scatter3(x_para,y_para,error_rb_l2_velocity,'*')
% axis tight
% xlabel('x-coordinate of tip')
% ylabel('y-coordinate of tip')
% zlabel('RB L^2 error velocity')
% title('Velocity RB absolute error')
% 
% figure()
% scatter3(x_para,y_para,error_rb_l2_pressure,'*')
% axis tight
% xlabel('x-coordinate of tip')
% ylabel('y-coordinate of tip')
% zlabel('RB L^2 error pressure')
% title('Pressure RB absolute error')
% 
