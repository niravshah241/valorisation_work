function [params_reduced, paramsP_reduced, stifness_matrix_reduced, ...
    rhs_reduced] = galerkin_formulation_extension_obsolete(stifness_matrix, rhs, params, ...
    paramsP, grid, red_dim_velocity, red_dim_pressure, B_velocity, B_pressure)
...
disp('Review plotting for schur for reduced solution.')
disp('Think : Change input to plot from rhs_reduced to B*rhs_reduced.')
pause()
end