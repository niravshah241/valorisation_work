function L = ldg_numerical_flux_operator_fct(lcoord,grid,params)
...
%                 * |Det(DF)|
%
% triaquad of this function should give the desired result used in
% ldg_operaotors_adv_explicit
...
if (decomp_mode == 2)
  ...
  Phi_hats_derivative = ldg_evaluate_basis_derivative(lcoord,params);
